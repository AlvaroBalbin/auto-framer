...
class SelectSpeaker:
    ...
    def __init__(self, stickiness: float = 0.3, hold_frames: int = 30):
    ...
    def select(self, tracks: list[Track], vad_activity: bool) -> int:
        if not tracks:
        ...
        for t in tracks:
            ...
            base = t.mouth_activity
            t.score = base if vad_activity else 0.5 * base # reduce score half everytime
